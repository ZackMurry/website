...
const ProfileSection: FC = () => {
  ...
  return (
    ...
    >
      ...
      {showContact && (
        <Box w='100%'>
          <ContactLink icon={EmailIcon} mt='7px' link='mailto:zjmfrr@missouri.edu' text='Email' />
          <ContactLink icon={FaGithub} mt='7px' link='https://github.com/ZackMurry' text='GitHub' />
          <ContactLink icon={FaLinkedin} mt='5px' link='https://linkedin.com/in/zack-murry' text='LinkedIn' />
        </Box>
      )}
    </Stack>
  )
