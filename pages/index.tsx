import { Box, Flex, Heading, Stack, Text, useBreakpointValue, useColorModeValue } from '@chakra-ui/react'
...
const ResearchSection: FC = () => {
  ...
  return (
    <Box mt='50px' mx={{ base: 'auto', xl: '0px' }}>
      ...
      <Text fontSize={{ base: '14px', xl: '18px' }} mt='15px'>
        My work in the VIMAN lab is mostly on designing and executing experiments on the NSF-funded Aerial Experimentation
        and Research Platform for Advanced Wireless (
        ...
        offloading and control networking for video transmission applications, as well as truck-drone package delivery
        systems.
      </Text>
      ...
      <Text fontSize={{ base: '14px', xl: '18px' }} mt='15px'>
        ...
        infrastructure for managing experiments in contexts outside of broadband speed/reliability. We are prototyping the
        use of Google Coral environmental sensors to collect data about the air quality, weather, and more in a distributed
  ...
  return (
    <Box mt='50px' mx={{ base: 'auto', xl: '0px' }}>
      ...
      <Text
        ...
        mt='5px'
      >
        ChesSRS is an interactive chess learning website that uses a flashcard-like spaced-repetition system (SRS) for
        practicing opening moves.
      </Text>
      ...
      >
        ...
        is a Chrome extension for Google Docs that allows the creation of complex shortcuts. It has over 2,500 weekly users
      ...
      >
        ...
        programmer for my high school's FTC robotics team for two years, and I currently volunteer at local tournaments to
        help score matches.
      </Text>
    </Box>
  )
