  ...
  <div className='mx-auto grid max-w-2xl gap-12 px-4 py-8 pb-12 sm:px-8 leading-relaxed text-zinc-600'>
    ...
    <div className='grid gap-0'>
      ...
      <h4 className='text-zinc-600 text-sm mt-1'>
        ...
        for all of these projects can be found on my <ExternalLink href='https://github.com/ZackMurry'>GitHub</ExternalLink>.
      </h4>
    </div>
    <article className='text-zinc-600 grid gap-4'>
      <p>
        ...
        for creating custom hotkeys for Google Docs, which I released in 2022. It's slowly grown over the years, and it now
        has almost 10,000 weekly active users. I still add new features, respond to support emails, and repair it when Google
        tweaks the Docs UI every year.
      </p>
      <p>
