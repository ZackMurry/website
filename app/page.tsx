    ...
    <article>
      <div className='grid gap-4 text-zinc-600'>
        <p>
          ...
          interning at <ExternalLink href='https://garmin.com'>Garmin</ExternalLink> in Olathe, KS, on the API team for the
          ...
          research routing algorithms for drone package delivery systems using reinforcement learning. I'm passionate about
          web development, computer science, and building software that solves real-world problems.
        </p>
        <p>
        ...
        <p>
          ...
          learning chess openings using a Spaced Repetition System (SRS), and I'm currently developing a tool for students to
          organize and streamline their coursework in Notion without having to manually track their assignments.
        </p>
      </div>
    </article>
  </div>
