  ...
  <div className='mx-auto grid max-w-2xl gap-12 px-6 py-8 pb-12 sm:px-8 leading-relaxed text-zinc-600'>
    ...
    <article>
      <div className='grid gap-4 text-zinc-600'>
        <p>
          I&apos;m a computer science and math student at the University of Missouri from Springfield, MO. Last summer, I
        ...
        <p>
          In 2024, I interned at the University of Chicago researching distributed computing using Raspberry Pis over 5G
          networks as part of the BigDataX Research Experience for Undergraduates (REU) program.
        </p>
        <p>
          I&apos;m currently working on <ExternalLink href='https://syntraix.com'>Syntraix</ExternalLink>. I&apos;ve also
          recently released <ExternalLink href='https://canvas-sync.com'>Canvas Sync for Notion</ExternalLink>, a tool for
          students to track their coursework in Notion without having to manually copy assignments from Canvas.
        </p>
      </div>
    </article>
  </div>
